...
@when(parsers.parse('actualizo el titulo del gasto con id {expense_id:d} a "{new_title}"'))
...
@then(parsers.parse('el titulo del gasto con id {expense_id:d} debe ser "{expected_title}"'))
...
@when(parsers.parse("actualizo el monto del gasto con id {expense_id:d} a {new_amount:d}"))
